...
2. Select 'Radio Operator Certificate' from the list of services.
3. Choose 'Renewal' as the application type.
4. Upload your current certificate and updated ID photo.

Failure to renew before the expiration date will result in a surcharge as prescribed by NTC MC No. 19-12-2002.

For more information, visit the [Radio Operator Certificate](/services/radio-operator-certificate/) service page.
